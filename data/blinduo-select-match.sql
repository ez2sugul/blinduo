...
# 현재 사용자 선호조건 
and matchingUser.`my-company` not in ('nhn', 'neowiz', 'skplanet')
...
# 상대방 선호조건
and matchingUser.`exclude-company` not like '%skplanet%' 
and matchingUser.`exclude-religion` not like '%none%' 
